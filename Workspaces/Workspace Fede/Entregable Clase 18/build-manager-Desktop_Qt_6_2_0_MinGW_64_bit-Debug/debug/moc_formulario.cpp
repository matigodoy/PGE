...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Formulario_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Formulario_t qt_meta_stringdata_Formulario = {
    {
QT_MOC_LITERAL(0, 10), // "Formulario"
QT_MOC_LITERAL(11, 14), // "mostrarVentana"
QT_MOC_LITERAL(26, 0), // ""
QT_MOC_LITERAL(27, 19) // "slot_mostrarVentana"

    },
    "Formulario\0mostrarVentana\0\0"
    "slot_mostrarVentana"
};
...
void Formulario::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->mostrarVentana(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Formulario::mostrarVentana)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Formulario::staticMetaObject = { {
    ...
    qt_meta_stringdata_Formulario.offsetsAndSize,
    qt_meta_data_Formulario,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Formulario_t
, QtPrivate::TypeAndForceComplete<Formulario, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void Formulario::mostrarVentana()
{
