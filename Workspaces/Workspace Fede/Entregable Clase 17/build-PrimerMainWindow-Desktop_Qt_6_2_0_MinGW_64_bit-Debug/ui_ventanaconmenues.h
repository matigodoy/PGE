...
public:
    ...
    void setupUi(QMainWindow *VentanaConMenues)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/recursos/abrir.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionNuevo->setIcon(icon1);
        actionAbrir = new QAction(VentanaConMenues);
        actionAbrir->setObjectName(QString::fromUtf8("actionAbrir"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/recursos/open.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/recursos/save.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/recursos/save as.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionGuardar_como->setIcon(icon4);
        actionCerrar = new QAction(VentanaConMenues);
        actionCerrar->setObjectName(QString::fromUtf8("actionCerrar"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/recursos/close.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionCerrar->setIcon(icon5);
        actionImprimir = new QAction(VentanaConMenues);
        actionImprimir->setObjectName(QString::fromUtf8("actionImprimir"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/recursos/print.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionImprimir->setIcon(icon6);
        ...
        toolBar_2 = new QToolBar(VentanaConMenues);
        toolBar_2->setObjectName(QString::fromUtf8("toolBar_2"));
        VentanaConMenues->addToolBar(Qt::TopToolBarArea, toolBar_2);
        ...
        toolBar_2->addAction(actionGuardar);
    ...
    void retranslateUi(QMainWindow *VentanaConMenues)
    {
        ...
        toolBar_2->setWindowTitle(QCoreApplication::translate("VentanaConMenues", "toolBar_2", nullptr));
    } // retranslateUi
